...
REPO="${DOCKERMGRREPO:-https://github.com/dockermgr}/golang"
APPVERSION="$(__appversion "$REPO/raw/${GIT_REPO_BRANCH:-main}/version.txt")"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Defaults variables
APPNAME="golang"
INSTDIR="$HOME/.local/share/dockermgr/golang"
APPDIR="$HOME/.local/share/srv/docker/golang"
DATADIR="$HOME/.local/share/srv/docker/golang/files"
...
HUB_URL="casjaysdevdocker/golang:latest"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
if [ -z "$HUB_URL" ] || [ "$HUB_URL" = "hello-world" ] || echo "$HUB_URL" | grep -q "golang"; then
